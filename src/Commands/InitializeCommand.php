...
class InitializeCommand extends Console\Command\Command
{
	...
	private function createNewConfiguration(Style\SymfonyStyle $io): void
	{
		...
		try {
			...
			$connector = $this->connectorsManager->create(Utils\ArrayHash::from([
				'entity'     => Entities\ModbusConnectorEntity::class,
	...
	private function askMode(Style\SymfonyStyle $io): Types\ClientModeType
	{
		...
		if ($mode === self::CHOICE_QUESTION_RTU_MODE) {
			return Types\ClientModeType::get(Types\ClientModeType::MODE_RTU);
		}

		if ($mode === self::CHOICE_QUESTION_TCP_MODE) {
			return Types\ClientModeType::get(Types\ClientModeType::MODE_TCP);
		}
